	...
	<form name="frm1" action="login_ok.jsp" method="post">
		<table width="100%" border="0" cellpspacing="0" cellpadding="0">
			<tr>
				...
				<table width="815" border="0" cellpspacing="0" cellpadding="0">
				<tr>
				...
				<tr>
					...
					<tr>
						<td width="574" height="45" align="center" class="new_tit">로그인</td>
					</tr>
					<tr>
						<td align="center">
						...
						<tr>
							...
							<td width="76%" align="left" bgcolor="#FFFFFF">
								<input type="text" size="15" maxlength="10" name="userid"></td>
						</tr>
						<tr>
							<td width="24%" align="left" bgcolor="#EEEEEE">비밀번호</td>
							<td width="76%" align="left" bgcolor="#FFFFFF">
								<input type="password" size="15" maxlength="10" name="passwd"></td>
						</tr>
						<tr>
							<td colspan="2" align="center" bgcolor="#FFFFFF">
								<input type="button" value="로그인" onclick="valid_check()"></td>
						</tr>								
					</table>
						</td>
						</tr>
